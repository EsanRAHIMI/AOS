/**
 * Architect Agent — service design + (Phase 13) evidence-grounded improvement plans.
 *
 * When given research findings, it reasons through the LLM router (schema-validated,
 * deterministic fallback) into a concrete improvement plan, persisting an LLM trace,
 * a cost record and an evidence record. Otherwise it produces a service design.
 */
import {
