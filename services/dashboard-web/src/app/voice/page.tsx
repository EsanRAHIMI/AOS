  ...
  return (
    <>
      ...
      <div className="grid cols-4" style={{ marginBottom: 16 }}>
        ...
        <MetricCard label="Live assistant" value="Jarvis" hint="dock on every page · /" tone="ok" />
      </div>
      <div className="card">
